...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('trkegiatan', function (Blueprint $table) {
            $table->id();
            $table->foreignId('programoutcomeoutputactivity_id')->constrained()->onDelete('cascade');
            ...
            $table->foreignId('kategorilokasikegiatan_id')->constrained()->onDelete('cascade');
            ...
            $table->foreignId('jenisbantuan_id')->nullable()->constrained()->onDelete('cascade');
            $table->foreignId('satuan_id')->nullable()->constrained()->onDelete('cascade');
