<x-adminlte-modal id="EditPartnerModal" title="" theme="success" icon="fas fa-handshake" size='lg'>
    <div class="card-body">
        {{-- Edit Role Form --}}
        <form id="EditPartnerForm" method="PATCH" class="resettable-form" data-toggle="validator" autocomplete="off"  @submit.prevent="handleSubmit" novalidate>
            ...
            <button type="submit" class="btn btn-success float-right btn-update-role" id="UpdateParterButton">
