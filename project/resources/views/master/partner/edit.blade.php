<div class="card-body">
    {{-- Edit Role Form --}}
    <form id="EditPartnerForm" method="POST" class="resettable-form" data-toggle="validator" autocomplete="off"  @submit.prevent="handleSubmit" novalidate>
        @csrf
        @method('POST')
        {{-- Partner Name --}}
        ...
        <button type="submit" class="btn btn-block btn-info btn-update-role">
