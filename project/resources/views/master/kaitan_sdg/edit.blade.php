<x-adminlte-modal id="editKaitanSdgModal" title="Update Kaitan SDG" size="lg" theme="info" icon="fas fa-pencil-alt" v-centered static-backdrop scrollable>
    <div class="modal-body">
        <form action="#" @submit.prevent="handleSubmit" method="PATCH" class="resettable-form" id="editKaitanSdgForm" autocomplete="off" novalidate>
            @csrf
            @method('PATCH')
            <input type="hidden" name="id" id="id">
            <div class="form-group">
                <label for="editnama">{{ trans('cruds.kaitan_sdg.nama') }}</label>
