<div class="card card-primary collapsed-card">
    ...
    <div class="card-body">
        {{-- form add kecamatan --}}
        <form action="#" method="PUT" class="resettable-form" id="kecamatanForm" autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input placeholder="" type="text" id="kode" name="kode" class="form-control" required data-placement="left" data-toggle="tooltip" data-placement="top" maxlength="8">
            </div>
            <div class="form-group">
            ...
            <button class="btn btn-success float-right btn-add-kecamatan" data-toggle="tooltip" data-placement="top" title="{{ trans('global.update') }}"><i class="fas fa-update"></i> {{ trans('global.update') }}</button>
        </form>
    </div>
</div>