...
@section('content_body')
    ...
    <div class="card card-outline card-primary">
        <div class="card-body">
            <table id="mjabatan_list"
                   class="table table-bordered table-striped ajaxTable datatable-mjabatan"
                   style="width:100%">
                <thead>
                    <tr class="text-center">
                        <th width="5%">No</th>
                        <th>{{ trans('cruds.mjabatan.nama') }}</th>
                        <th>{{ trans('cruds.mdivisi.title') }}</th>
                        <th width="10%">Manager</th>
                        <th width="8%">{{ trans('cruds.status.title') }}</th>
