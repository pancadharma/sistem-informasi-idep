        ...
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea type="objektif_deskripsi" id="objektif_deskripsi" name="objektif_deskripsi"
                    ...
                    placeholder=" {{ __('cruds.program.outcome.desc') }}" rows="5" maxlength="5000">{{ old('objektif_deskripsi', $program->objektif->deskripsi ?? '') }}</textarea>
            </div>
        ...
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea id="objektif_indikator" name="objektif_indikator" cols="30"
                    ...
                    placeholder="{{ __('cruds.program.outcome.indicator') }}" maxlength="5000" rows="5">{{ old('objektif_indikator', $program->objektif->indikator ?? '') }}</textarea>
            </div>
            <small class="text-muted character-counter"></small>
        </div>
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea id="objektif_target" name="objektif_target" cols="30"
                    ...
                    placeholder="{{ __('cruds.program.outcome.target') }}" maxlength="5000" rows="5">{{ old('objektif_target', $program->objektif->target ?? '') }}</textarea>
            </div>
            <small class="text-muted character-counter"></small>
        </div>
    </div>
