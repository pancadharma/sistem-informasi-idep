        ...
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea type="objektif_deskripsi" id="objektif_deskripsi" name="objektif_deskripsi"
                    ...
                    placeholder=" {{ __('cruds.program.outcome.desc') }}" rows="1" maxlength="1000">{{ old('objektif_deskripsi', $program->objektif->deskripsi ?? '') }}</textarea>
            </div>
        </div>
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea id="objektif_indikator" name="objektif_indikator" cols="30"
                    ...
                    placeholder="{{ __('cruds.program.outcome.indicator') }}" maxlength="1000" rows="1">{{ old('objektif_indikator', $program->objektif->indikator ?? '') }}</textarea>
            </div>
        </div>
        <div class="col-lg-4 form-group">
            <div class="input-group">
                ...
                <textarea id="objektif_target" name="objektif_target" cols="30"
                    ...
                    placeholder="{{ __('cruds.program.outcome.target') }}" maxlength="1000" rows="1">{{ old('objektif_target', $program->objektif->target ?? '') }}</textarea>
            </div>
        </div>
    </div>
</div>
