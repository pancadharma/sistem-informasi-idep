...
@push('js')
        ...
        $(document).on('click', '.kv-file-remove', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#file-input').on('fileremoved', function(event, id, index) {
                        initializeFileInput();
                        console.log
                    });
                    if (response.success) {
    ...
    <script>
        ...
        function initializeFileInput(response) {
            ...
            }).on('change', function(event, file, previewId, index, reader) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            fetchMediaAndInitFileInput();
                            console.log(
                                'fetchMediaAndInitFileInput called after delete success');
