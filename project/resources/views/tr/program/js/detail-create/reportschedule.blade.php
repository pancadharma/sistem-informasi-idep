        ...
        `<div class="row" id=${i}>
            <div class="col-lg-3 form-group">
                <div class="input-group">
                    ...
                    <input type="date" id="tanggal" name="tanggallokasi[]" class="form-control">
                </div>
            </div>
            ...
            <div class="col-lg-3 form-group">
                <div class="input-group">
                    ...
                    <textarea name="keteranganlokasi[]" class="form-control" placeholder="keterangan" rows="1"></textarea>
