...
@section('subtitle', __('global.create') . ' ' . __('cruds.kegiatan.label'))
@section('content_header_title', __('global.create') . ' ' . __('cruds.kegiatan.label'))
@section('sub_breadcumb', __('cruds.kegiatan.label'))
