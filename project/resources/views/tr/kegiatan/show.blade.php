...
<div class="card card-outline card-primary mb-3">
    <div class="card-header d-flex align-items-center">
        ...
        <div class="card-tools ml-auto">
            <button type="button" class="btn btn-sm btn-default" onclick="window.location.href=`{{ route('kegiatan.index') }}`"
...
<div class="row">
    ...
    <div class="col-12 col-lg-8 order-sm-2 order-lg-1">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <p class="text-muted lead mb-0">
                            ...
                            <span class="badge {{ $kegiatan->status == 'approved' ? 'badge-success' : 'badge-warning' }} ml-2">
                ...
                <div class="row">
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="p-3 bg-light rounded border-left border-success h-100">
                            <h6 class="text-uppercase text-muted font-weight-bold mb-1"><i class="fas fa-project-diagram mr-1"></i> Program</h6>
                    ...
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="p-3 bg-light rounded border-left border-info h-100">
                            <h6 class="text-uppercase text-muted font-weight-bold mb-1"><i class="fas fa-layer-group mr-1"></i> Jenis Kegiatan</h6>
                            <span class="badge badge-info text-wrap text-left mt-1">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="p-3 bg-light rounded border-left border-warning h-100">
                            <h6 class="text-uppercase text-muted font-weight-bold mb-1"><i class="fas fa-flag-checkered mr-1"></i> Fase Pelaporan</h6>
                            <span class="h5 font-weight-bold text-dark mb-0">{{ $kegiatan->fasepelaporan ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive mb-4">
                    <table class="table table-sm table-borderless">
                        <tbody>
                            <tr>
                                <td width="30%" class="text-muted"><strong><i class="far fa-clock mr-1"></i> Waktu Pelaksanaan</strong></td>
                                <td width="2%">:</td>
                                <td>
                            ...
                            <tr>
                                <td class="text-muted"><strong><i class="fas fa-map-marker-alt mr-1"></i> Lokasi</strong></td>
                                <td>:</td>
                                <td>
                            ...
                            <tr>
                                <td class="text-muted"><strong><i class="fas fa-handshake mr-1"></i> Mitra/Pihak Terlibat</strong></td>
                                <td>:</td>
                                <td>
                ...
                <div class="mb-4 bg-light rounded p-3 border">
                    <h5 class="font-weight-bold mb-3 text-dark border-bottom pb-2">
                        <i class="fas fa-users-cog mr-2 text-secondary"></i> {{ __('cruds.kegiatan.peserta.label') }} (Disagregat)
                    </h5>
                    
                    <h6 class="text-sm font-weight-bold mt-2">Peserta Berdasarkan Usia</h6>
                    <div class="table-responsive mb-3">
                        <table class="table table-sm table-bordered table-hover bg-white mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ __('cruds.kegiatan.peserta.dewasa') }} <em>(25-59)</em></td>
                                ...
                                <tr>
                                    <td>{{ __('cruds.kegiatan.peserta.lansia') }} <em>(60+)</em></td>
                                ...
                                <tr>
                                    <td>{{ __('cruds.kegiatan.peserta.remaja') }} <em>(18-24)</em></td>
                                ...
                                <tr>
                                    <td>{{ __('cruds.kegiatan.peserta.anak') }} <em>(< 18)</em></td>
                                ...
                                <tr class="table-primary">
                                    <td><strong>TOTAL USIA</strong></td>
                    ...
                    <h6 class="text-sm font-weight-bold mt-2">Kelompok Khusus</h6>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-hover bg-white mb-0">
                            <thead class="thead-dark">
                                <tr>
                                    <th width="25%" class="align-middle">Penerima Manfaat</th>
                                    <th class="text-center align-middle" width="18%">{{ __('cruds.kegiatan.peserta.wanita') }}</th>
                                    <th class="text-center align-middle" width="18%">{{ __('cruds.kegiatan.peserta.pria') }}</th>
                                    <th class="text-center align-middle" width="18%">Lainnya</th>
                                    <th class="text-center align-middle" width="21%">Sub Total</th>
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                <div class="rich-text-content">
                    {!! $kegiatan->deskripsikeluaran ?? '<em class="text-muted">Tidak ada data keluaran.</em>' !!}
                </div>
            </div>
        </div>
        ...
        <div class="sticky-top" style="top: 80px; z-index: 1000;">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white font-weight-bold border-bottom-0 pt-3 pb-2">
                    <i class="fas fa-bullseye mr-2 text-danger"></i> Program Goals
                </div>
                <div class="card-body pt-0 pb-3 small">
                    @php
                        $goal = $kegiatan->programOutcomeOutputActivity?->program_outcome_output?->program_outcome?->program?->goal;
                    @endphp
                    @if($goal)
                        <div class="mb-3">
                            <span class="text-muted font-weight-bold text-uppercase d-block mb-1" style="font-size: 0.75rem;">Target</span>
                            <div class="p-2 bg-light rounded text-dark border-left border-danger">{{ $goal->target }}</div>
                        </div>
                        <div>
                            <span class="text-muted font-weight-bold text-uppercase d-block mb-1" style="font-size: 0.75rem;">Indikator</span>
                            <div class="p-2 bg-light rounded text-dark border-left border-warning">{{ $goal->indikator }}</div>
                        </div>
                    @else
                        <p class="text-muted italic mb-0">Tidak ada goal yang didefinisikan.</p>
                    @endif
                </div>
            </div>

            {{-- Metrics Card --}}
            <div class="card shadow-sm border-0 mb-4 bg-primary text-white" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
                <div class="card-body p-4">
                    <h5 class="font-weight-bold mb-4 border-bottom border-white-50 pb-2 text-center">
                    ...
                    <div class="row text-center mb-0">
                        <div class="col-6 mb-3">
                            <div class="bg-white-10 rounded p-2 border border-white-20 h-100 d-flex flex-column justify-content-center">
                                ...
                                <small class="text-uppercase small text-white-50">Perempuan</small>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="bg-white-10 rounded p-2 border border-white-20 h-100 d-flex flex-column justify-content-center">
                                <h2 class="font-weight-bold mb-0 text-white">{{ number_format($kegiatan->penerimamanfaatlakilakitotal ?? 0) }}</h2>
                                <small class="text-uppercase small text-white-50">Laki-Laki</small>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="bg-white-20 rounded p-3 mt-1 shadow-sm border border-white-50">
                                ...
                                <small class="text-uppercase font-weight-bold text-white">Total Partisipan</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white font-weight-bold border-bottom-0 pt-3 pb-2">
                    <i class="fas fa-pen-nib mr-2 text-info"></i> Tim Pelaksana
                </div>
                <div class="card-body pt-0 pb-3">
                    <div class="list-group list-group-flush">
                        ...
                        @empty
                            <div class="py-2 text-muted small italic text-center bg-light rounded">Tidak ada data pelaksana.</div>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white font-weight-bold border-bottom-0 pt-3 pb-2 d-flex align-items-center">
                    <div><i class="fas fa-file-alt mr-2 text-primary"></i> Dokumen</div>
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        @empty
                            <div class="px-3 py-3 text-muted small italic text-center bg-light mx-3 rounded mb-2 mt-2">Belum ada dokumen pendukung.</div>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white font-weight-bold border-bottom-0 pt-3 pb-2 d-flex align-items-center">
                    <div><i class="fas fa-images mr-2 text-success"></i> Media / Foto</div>
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        @empty
                            <div class="px-3 py-3 text-muted small italic text-center bg-light mx-3 rounded mb-2 mt-2">Belum ada foto/media.</div>
                        @endforelse
                    </div>
                </div>
            </div>
...
@section('plugins.Validation', true)
    ...
    <script>
        ...
        function previewFileFromData(element) {
            ...
            const name = element.getAttribute('data-name') || '{{ __('Preview') }}';

            // Sanitize name for HTML rendering to prevent XSS
            const safeName = $('<div/>').text(name).html();

            // Custom Download Button for Swal Footer
            const downloadBtnHtml = `<a href="${url}" download class="btn btn-success mt-3"><i class="fas fa-download mr-1"></i> Download File</a>`;
                ...
                if (isLocalhost) {
                    contentHtml = `
                        <div class="alert alert-warning text-left">
                            ...
                            <strong>Preview Tidak Tersedia di Localhost</strong><br>
                            Fitur preview dokumen Word/Excel/PPT membutuhkan aplikasi yang sudah online (bisa diakses publik). Silakan klik tombol download di bawah untuk melihat file.
                        </div>
                        <div class="text-center py-5 bg-light rounded border">
                            <i class="fas fa-file-alt fa-4x text-muted mb-3"></i><br>
                            <h5 class="text-muted">File: ${safeName}</h5>
                        </div>
                    `;
                } else {
                    contentHtml = `
                        <div class="alert alert-info text-left small mb-2 py-2">
                            <i class="fas fa-info-circle"></i> Jika preview blank/gagal memuat, file mungkin belum terindeks secara publik. Gunakan tombol download.
                        </div>
