    ...
    $(document).ready(function () {
        $('#kegiatan-list').DataTable({
            ...
            columns: [
                ...
                { data: 'duration_in_days', name: 'duration_in_days', title: '{{ __('cruds.kegiatan.durasi') }}', orderable: true, searchable: false }, //Consider change it searchable
                { data: 'fasepelaporan', name: 'fasepelaporan', title: '{{ __('cruds.kegiatan.fase') }}', orderable: true, searchable: true },
                { data: 'status', name: 'status', title: '{{ __('cruds.kegiatan.status') }}', orderable: true, searchable: true },
                { data: 'action', name: 'action', title: '{{ __('global.action') }}', orderable: false, searchable: false, className: 'text-center' }
            ],
            layout: {
                topStart: {
