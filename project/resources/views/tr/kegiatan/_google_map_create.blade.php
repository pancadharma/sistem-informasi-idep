...
<script>
    ...
    function initMap() {
        ...
        window.mapState.map = new google.maps.Map(document.getElementById("googleMap"), {
            ...
            mapId: "7e7fb1bfd929ec61" // Your mapId
        });
        ...
        // For create form, there are no initial locations from $kegiatan->lokasi
        // Markers will be added dynamically as user inputs data
