...
class UpdateKegiatanRequest extends FormRequest
{
    ...
    {
        // return false;
        return auth()->user()->id === 1 || auth()->user()->can('kegiatan_edit') || Gate::allows('kegiatan_edit');
    }
    ...
    public function rules(): array
    {
        $rules = [
            ...
            // penulis
            'penulis'                                   => ['array'],
            'penulis.*'                                 => ['nullable', 'integer', 'exists:users,id'], // Optional for updates
            'jabatan'                                   => ['array'],
            'jabatan.*'                                 => ['nullable', 'integer', 'exists:mperan,id'], // Optional for updates
            // lokasi validations
            'desa_id'                                   => ['array'],
            ...
            'lat'                                       => ['array'],
            'lat.*'                                     => ['nullable', 'numeric', 'between:-90,90'], // Stricter validation
            'long'                                      => ['array'],
